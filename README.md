...
yay -S picom blueman acpi dunst jq alsa-utils polkit-xfce4  rofi-blocks-git light numlockx flameshot feh lm_sensors  mantablockscreen network-manager-applet playerctl python3 parcellite redshift upower xorg-xinit xprintidle xorg wmctrl xdotool tumbler pavucontrol ttf-jetbrains-mono-nerd cpufrequtils asciidoc xclip update-grub os-prober efibootmgr grub-customizer yazi terminus-font power-profiles-daemon st-fl-git
