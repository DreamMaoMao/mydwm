...
static const unsigned int bartagalpha = 0xff; /* bar tag模块透明度 */
...
static const char *colors[][3] = {
    ...
    [SchemeSel] = {"#2d1802", "#a39a82", "#c9b890"},
    ...
    [SchemeSelTag] = {"#000000", "#ddca9e", NULL},
...
static const unsigned int alphas[][3] = {
    ...
    [SchemeNormTag] = {OPAQUE, bartagalpha, bartagalpha},
    [SchemeSelTag] = {OPAQUE, bartagalpha, bartagalpha},
...
static const Rule rules[] = {
    ...
    {"Pot",    NULL,                 NULL,             0,            1,          0,          0,        -1,      5,            0,       0},       // dragon            noborder
...
static Key keys[] = {
    ...
    { AltMask|ShiftMask,        XK_Right,        focusmon,         {.i = +1} },    
    { AltMask|ShiftMask,        XK_Left,         focusmon,         {.i = -1} },               

    { AltMask|SuperMask,        XK_Right,        tagmon,           {.i = +1} },   
    { AltMask|SuperMask,        XK_Left,         tagmon,           {.i = -1} },    
    ...
    { ShiftMask|ControlMask,      XK_Up,           movewin,          {.ui = UP} },              /* alt ctrl up      |  移动窗口 */
    { ShiftMask|ControlMask,      XK_Down,         movewin,          {.ui = DOWN} },            /* alt ctrl down    |  移动窗口 */
    { ShiftMask|ControlMask,      XK_Left,         movewin,          {.ui = LEFT} },            /* alt ctrl left    |  移动窗口 */
    { ShiftMask|ControlMask,      XK_Right,        movewin,          {.ui = RIGHT} },           /* alt ctrl right   |  移动窗口 */

    { ControlMask|AltMask,        XK_Up,           resizewin,        {.ui = V_REDUCE} },        /* super alt up       |  调整窗口大小 */
    { ControlMask|AltMask,        XK_Down,         resizewin,        {.ui = V_EXPAND} },        /* super alt down     |  调整窗口大小 */
    { ControlMask|AltMask,        XK_Left,         resizewin,        {.ui = H_REDUCE} },        /* super alt left     |  调整窗口大小 */
    { ControlMask|AltMask,        XK_Right,        resizewin,        {.ui = H_EXPAND} },        /* super alt right    |  调整窗口大小 */
...
static Button buttons[] = {
    ...
    { ClkClientWin,        AltMask|ControlMask,         Button1,          spawn, SHCMD("bash ~/tool/shotTranslate.sh shot") },      //alt + shift + 左键  |  触发截图翻译 
